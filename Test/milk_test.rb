...
class MyTest < Test::Unit::TestCase
  ...
  def test_get_cubic_capacity
    test_milk = Milk.new(101, 1000, 'Plain Milk inc.', Date.strptime('2017-01-01', '%Y-%m-%d'), 2.8, 210)
  ...
  def test_incorrect_data_to_initialize_milk
    assert_raise ArgumentError do
      Milk.new(101, 1000, 'Plain Milk inc.', Date.strptime('2017-01-01', '%Y-%m-%d'), 28, 210)
    end
  end

  def test_is_milk_still_under_guarantee
    test_date = Date.today + 1
    test_milk = Milk.new(101, 1000, 'Plain Milk inc.', test_date, 2.8, 210)
